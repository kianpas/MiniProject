...
public class BeanChoice {
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == small1) {
					flavor = 1;
					flavorLabel.setText("도미니카 AA" + flavor);
				} else if (e.getSource() == medium1) {
					flavor = 2;
					flavorLabel.setText("코스타리카 SHB" + flavor);
				} else if (e.getSource() == large1) {
					flavor = 3;
					flavorLabel.setText("콜롬비아 슈프리모" + flavor);
				}
	...
	private void resultPanel() {
		...
		result = new JLabel();
		result.setText(String.valueOf(flavor));
//		if(bitter == 1 && acid ==1 && flavor ==1) {
//			result.setText(String.valueOf(acid));
//			
//		}
		
		result.setFont(new Font("맑은 고딕", Font.BOLD, 14));
